...
public class BorrowManagerImpl implements BorrowManager {
    ...
    @Override
    @Transactional
    public Reservation save(Reservation borrow, String operationType) throws FunctionnalException {
        ...
        Reservation savedBorrow = borrowDao.save(BorrowToSave);
    ...
    @Override
    public List<Reservation> getAllBorrowsByRegistereduserId(int userId) {
        return borrowDao.findByRegistereduserId(userId);
    }

    @Override
    public List<Reservation> getAllBorrowsByBookIdAndLibraryId(int book_id, int library_id) {
...
/**
    ...
    public void checkIfReturnDateIsOutDated(Reservation borrow) throws FunctionnalException {
...
/**
    ...
    public void checkIfBorrowIsAlreadyExtended(Reservation borrow) throws FunctionnalException {
