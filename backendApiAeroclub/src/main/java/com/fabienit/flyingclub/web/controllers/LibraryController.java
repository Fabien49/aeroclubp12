...
import com.fabienit.biblioapi.dao.FlyingClubDao;
...
public class LibraryController {
    ...
    public List<Library> getLibraries() {
        ...
        List<Library> libraries = flyingClubDao.findAll();
    ...
    public Optional<Library> getLibraryById(@PathVariable @Min(value = 1) int id) {
        ...
        Optional<Library> library = flyingClubDao.findById(id);
    ...
    public ResponseEntity<Void> addLibrary(@Valid @RequestBody Library library) {
        ...
        try {
            libraryAdded = flyingClubDao.save(library);
        } catch (Exception e) {
    ...
    public ResponseEntity<Void> updateLibrary(@PathVariable @Min(value = 1) int id, @Valid @RequestBody Library libraryDetails) {
        ...
        try {
            flyingClubDao.findById(libraryDetails.getId()).get();
        ...
        flyingClubDao.save(libraryDetails);
