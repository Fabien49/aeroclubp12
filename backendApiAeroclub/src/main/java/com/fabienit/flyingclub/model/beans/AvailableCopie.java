...
public class AvailableCopie {
    ...
    public AvailableCopie(@NotNull @Valid AvailableCopieKey id, Aircraft aircraft, Library library, @NotNull int ownedQuantity, @NotNull int availableQuantity, @NotNull Boolean bookCanBeReserved, @NotNull LocalDate nearestReturnDate, @NotNull int reservationCount) {
        this.id = id;
    ...
    public Aircraft getBook() {
        return aircraft;
    }

    public void setBook(Aircraft aircraft) {
        this.aircraft = aircraft;
    }
