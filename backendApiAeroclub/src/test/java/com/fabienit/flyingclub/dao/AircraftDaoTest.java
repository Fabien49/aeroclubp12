...
public class AircraftDaoTest {
    ...
    private Aircraft aircraftToSave;
   ...
   @Test
    ...
    public void testFindByTitleIgnoreCaseContainingOrAuthorLastNameIgnoreCaseContaining(){
        ...
        // WHEN
        List<Aircraft> listAircraft = bookDao.findByTitleIgnoreCaseContainingOrAuthorLastNameIgnoreCaseContaining("toto2041", "Chapeau");

        //THEN
        assertEquals("toto2041", listAircraft.get(0).getTitle());
        assertEquals("Chapeau", listAircraft.get(0).getAuthorLastName());
