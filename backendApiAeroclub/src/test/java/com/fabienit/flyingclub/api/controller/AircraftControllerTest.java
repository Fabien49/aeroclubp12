...
public class AircraftControllerTest {
   ...
   @BeforeEach
    ...
    public void givenBookId_whenGetNonExistingBook_thenReturns200() {
        ...
        //when
        ResponseEntity<Aircraft> responseEntity = testRestTemplate.getForEntity("/books/"+bookId, Aircraft.class);
   ...
   public void givenNewBook_whenPostBook_thenReturns201() {
      ...
      Aircraft aircraft = new Aircraft(1, "title", "authorFirstName", "authorLastName", LocalDate.of(2022,3,20),"synopsis", "pictureURL", null, null);
    ...
    public void givenBookAndBookId_whenPutBook_thenReturns200() {
        ...
        //given
        int bookId = 1;
        ResponseEntity<Aircraft> bookResponseEntity = testRestTemplate.getForEntity("/books/"+bookId, Aircraft.class);
        Aircraft aircraftToSave = bookResponseEntity.getBody();
        HttpEntity<Aircraft> request = new HttpEntity<>(aircraftToSave);

        //when
        ResponseEntity<Aircraft> responseEntity = testRestTemplate.exchange("/books/"+bookId, HttpMethod.PUT,request, Aircraft.class);
