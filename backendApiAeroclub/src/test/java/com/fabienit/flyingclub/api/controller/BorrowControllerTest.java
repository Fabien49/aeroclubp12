...
import com.fabienit.biblioapi.AeroclubApiApplication;
import com.fabienit.biblioapi.model.beans.Aircraft;
...
@SpringBootTest(webEnvironment = RANDOM_PORT, classes = AeroclubApiApplication.class)
...
public class BorrowControllerTest {
   ...
   @BeforeEach
    ...
    public void givenBorrowId_whenGetNonExistingBorrow_thenReturns200() {
        ...
        //when
        ResponseEntity<Reservation> responseEntity = testRestTemplate.getForEntity("/borrows/"+borrowId, Reservation.class);

        //then
        assertEquals(OK, responseEntity.getStatusCode());
        assertNotNull(responseEntity.getBody());
        assertNotNull(responseEntity.getBody().getBorrowingDate());
        assertNotNull(responseEntity.getBody().getReturnDate());
        assertNotNull(responseEntity.getBody().getRegisteredUser());
        assertNotNull(responseEntity.getBody().getAircraft());
    }
...
/*    @Test
    ...
    public void givenBorrowAndBorrowId_whenPutBorrow_thenReturns200() {
        ...
        //given
        int borrowId = 1;
        ResponseEntity<Reservation> borrowResponseEntity = testRestTemplate.getForEntity("/borrows/"+borrowId, Reservation.class);
        Reservation borrowToSave = borrowResponseEntity.getBody();
        HttpEntity<Reservation> request = new HttpEntity<>(borrowToSave);

        //when
        ResponseEntity<Reservation> responseEntity = testRestTemplate.exchange("/borrows/"+borrowId, HttpMethod.PUT,request, Reservation.class);
...
/*        //when
    ...
    public void givenBorrowAndBorrowId_whenPutExtendBorrow_thenReturns200() {
        ...
        //when
        ResponseEntity<Reservation> responseEntity = testRestTemplate.exchange("/borrows/extend/"+borrowId, HttpMethod.PUT,request, Reservation.class);
    ...
    public void givenBorrowAndBorrowId_whenPutReturnBorrow_thenReturns200() {
        ...
        //when
        ResponseEntity<Reservation> responseEntity = testRestTemplate.exchange("/borrows/return/"+borrowId, HttpMethod.PUT,request, Reservation.class);
    ...
    public void whenDeleteBorrow_thenReturns200() {
        ...
        //when
        ResponseEntity<Reservation> responseEntity = testRestTemplate.exchange("/borrows/"+borrowId, HttpMethod.DELETE,request, Reservation.class);
